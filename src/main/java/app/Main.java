...
public class Main {
    public static void main(String[] args) {
        ...
        clienteDAO.listar().forEach(c -> System.out.println(c.getNome() + " - " + c.getEmail() + " - " + c.getTelefone()));

        System.out.println("Produtos cadastrados:");
        produtoDAO.listar().forEach(p -> System.out.println(p.getNome() + " - R$" + p.getPreco() + " - " + p.getDescricao()));
